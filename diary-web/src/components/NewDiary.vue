<template>
  <div class="div_1">
    <el-container>
      <el-header>
        <el-page-header style="margin-top: 25px" content="写日记" @back="goBack"></el-page-header>
      </el-header>
      ...
      <el-container>
        <el-aside class="aside_1">
          ...
          <el-button @click="click_submit" type="primary" class="button_submit">提交</el-button>
        </el-aside>
...
export default {
  ...
  methods:{
    mounted_edit_diary(){
      if(this.diary_id != ''){
        this.getRequest('/diary/article/'+this.diary_id).then(resp=>{
          if (resp){
